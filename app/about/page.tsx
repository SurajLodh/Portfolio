    ...
    <div className="min-h-screen bg-[#fcfcfc] dark:bg-[#0f172a] transition-colors duration-300 w-full pb-20 text-gray-900 dark:text-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-8 pb-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white dark:bg-gray-800 rounded-[2rem] p-10 shadow-sm border border-gray-100 dark:border-gray-800 flex flex-col justify-between space-y-12">
          ...
          <div className="bg-[#fbf5dc] dark:bg-[#403310] rounded-[2rem] p-10 shadow-sm flex flex-col justify-between space-y-12">
          ...
          <div className="bg-[#f1f5f9] dark:bg-gray-800 rounded-[2rem] p-10 shadow-sm lg:col-span-1 md:col-span-2 flex flex-col justify-between space-y-12">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-[2rem] p-10 shadow-sm border border-gray-100 dark:border-gray-800 lg:col-span-3 flex flex-col md:flex-row items-center justify-between gap-10">
