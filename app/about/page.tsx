    ...
    <div className="min-h-screen relative overflow-hidden pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 pt-12 lg:pt-20 pb-20 relative z-10">
        <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-20">
          ...
          <div className="flex-1 relative w-full flex justify-center lg:justify-end mt-12 lg:mt-0">
            ...
            <div className="border-4 border-foreground shadow-[12px_12px_0px_#1E293B] rounded-[2rem] overflow-hidden rotate-2 hover:rotate-0 transition-transform duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)]">
              <img
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 pb-32 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Card className="p-8 flex flex-col justify-between space-y-12 border-4 bg-white">
          ...
          <Card className="p-8 flex flex-col justify-between space-y-12 border-4 bg-tertiary">
            <div className="w-16 h-16 rounded-full bg-white border-2 border-foreground flex items-center justify-center shadow-pop">
            ...
            <div className="space-y-4">
              <h3 className="text-2xl font-headline text-foreground font-bold">Editorial UI</h3>
              <p className="text-base text-foreground/80 font-body font-medium leading-relaxed">
          ...
          <Card className="p-8 lg:col-span-1 md:col-span-2 flex flex-col justify-between space-y-12 border-4 bg-quaternary">
            ...
            <div className="space-y-4">
              <h3 className="text-2xl font-headline text-foreground font-bold">User Research</h3>
              <p className="text-base text-foreground/80 font-body font-medium leading-relaxed">
          ...
          <Card className="p-8 lg:col-span-3 flex flex-col md:flex-row items-center justify-between gap-10 border-4 bg-secondary">
            <div className="flex-1 space-y-4">
              <h3 className="text-3xl font-headline text-foreground font-bold">Visual Storytelling</h3>
              <p className="text-lg text-foreground/90 font-body font-medium leading-relaxed max-w-2xl">
                Moving beyond aesthetics to build brand narratives that resonate on an emotional level with high-value audiences.
              </p>
            </div>
            <div className="w-[180px] h-[100px] bg-white rounded-xl border-4 border-foreground shadow-[4px_4px_0px_#1E293B] flex items-center justify-center -rotate-2">
              ...
              {[
                ...
                <div key={i} className="flex justify-between items-center border-b-2 border-foreground pb-4 group">
                  <div className="flex items-center gap-4 text-foreground text-lg font-headline font-bold group-hover:translate-x-2 transition-transform">
                    <div className={`w-4 h-4 ${item.color} border-2 border-foreground rounded-full shadow-[2px_2px_0px_#1E293B]`}></div>
                    {item.tool}
                  </div>
                  <span className="text-xs text-muted-foreground uppercase tracking-widest font-bold bg-white px-3 py-1 rounded-full border-2 border-foreground">
                    {item.role}
                  </span>
                </div>
              ))}
          ...
          <div className="flex-1">
            ...
            <div className="space-y-12 relative border-l-4 border-foreground ml-4">
              <div className="relative pl-10">
                <div className="absolute top-0 -left-4 w-7 h-7 bg-white border-4 border-foreground rounded-full flex items-center justify-center">
                  <div className="w-2 h-2 bg-accent rounded-full"></div>
                </div>
                <div className="inline-block bg-tertiary px-3 py-1 rounded-full border-2 border-foreground text-[10px] font-bold text-foreground uppercase tracking-widest mb-4 shadow-[2px_2px_0px_#1E293B]">
                  2018 — 2020
                </div>
                ...
                <p className="text-base font-body font-medium text-foreground bg-white p-4 rounded-xl border-2 border-foreground shadow-[4px_4px_0px_#1E293B] mt-4">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
        <div className="bg-accent rounded-[2.5rem] p-8 md:p-12 lg:p-20 border-4 border-foreground shadow-[16px_16px_0px_#FBBF24] relative overflow-hidden text-center md:text-left">
          ...
          <div className="max-w-2xl relative z-10 mx-auto md:mx-0">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-headline font-extrabold text-white leading-tight mb-6 drop-shadow-[2px_2px_0px_#1E293B]">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-4">
              <Button asChild className="bg-tertiary text-foreground hover:bg-white text-lg px-8 py-4">
              ...
              <Button variant="secondary" asChild className="bg-white hover:bg-muted text-foreground text-lg px-8 py-4">
