...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-[#fcfcfc] w-full pb-20">
      
      {/* Hero Section */}
      <div className="max-w-7xl mx-auto px-8 pt-6 lg:pt-12 pb-20">
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
          <div className="flex-1 space-y-8 z-10 w-full">
            <div className="text-[10px] uppercase tracking-[0.2em] font-bold text-[#b08210] font-label">
              The Editorial Curator
            </div>
            <h1 className="text-5xl md:text-6xl lg:text-[72px] font-headline font-semibold text-gray-900 leading-[1.1] tracking-tight">
              Designing data- <br />
              informed stories <br />
          ...
          <div className="flex-1 relative w-full flex justify-center lg:justify-end">
            <div className="absolute top-0 right-10 w-72 h-72 bg-[#fbf5dc] rounded-full blur-3xl -z-10"></div>
            <img 
      ...
      <div className="max-w-7xl mx-auto px-8 pb-32">
        <div className="flex flex-col md:flex-row md:items-end justify-between border-b border-gray-200 pb-4 mb-12 gap-4">
          <h2 className="text-4xl font-headline italic font-semibold text-gray-900">Core Expertise</h2>
          <span className="text-[10px] uppercase tracking-widest text-gray-400 font-bold">Strategic Problem Solving</span>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white rounded-[2rem] p-10 shadow-sm border border-gray-100 flex flex-col justify-between space-y-12">
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-headline text-gray-900 font-semibold">Product Architecture</h3>
          ...
          <div className="bg-[#fbf5dc] rounded-[2rem] p-10 shadow-sm flex flex-col justify-between space-y-12">
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-headline text-gray-900 font-semibold">Editorial UI</h3>
          ...
          <div className="bg-[#f1f5f9] rounded-[2rem] p-10 shadow-sm lg:col-span-1 md:col-span-2 flex flex-col justify-between space-y-12">
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-headline text-gray-900 font-semibold">User Research</h3>
              <p className="text-sm text-gray-500 font-light leading-relaxed">
          ...
          <div className="bg-white rounded-[2rem] p-10 shadow-sm border border-gray-100 lg:col-span-3 flex flex-col md:flex-row items-center justify-between gap-10">
            <div className="flex-1 space-y-4">
              <h3 className="text-xl font-headline text-gray-900 font-semibold">Visual Storytelling</h3>
      ...
      <div className="max-w-7xl mx-auto px-8 pb-32">
        <div className="flex flex-col lg:flex-row gap-20">
          ...
          <div className="flex-1">
            <h2 className="text-4xl font-headline italic font-semibold text-gray-900 mb-12">The Toolkit</h2>
            <div className="space-y-6">
              {[
                ...
                <div key={i} className="flex justify-between items-center border-b border-gray-100 pb-4">
                  <div className="flex items-center gap-4 text-gray-900 text-sm font-medium">
          ...
          {/* Academic Journey */}
          <div className="flex-1">
            <h2 className="text-4xl font-headline italic font-semibold text-gray-900 mb-12">Academic Journey</h2>
            <div className="space-y-12 relative border-l border-gray-200 ml-2">
              <div className="relative pl-8">
                ...
                <h3 className="text-lg font-headline text-gray-900 font-semibold">Master of Human-Computer Interaction</h3>
                <div className="text-xs text-gray-500 mb-2 mt-1">Parsons School of Design, New York</div>
                <p className="text-sm font-light text-gray-500 italic mt-2">
              ...
              <div className="relative pl-8">
                ...
                <h3 className="text-lg font-headline text-gray-900 font-semibold">Bachelor of Communication Design</h3>
                <div className="text-xs text-gray-500 mb-2 mt-1">National Institute of Design (NID)</div>
                <p className="text-sm font-light text-gray-500 italic mt-2">
      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="bg-[#111827] rounded-[2.5rem] p-12 md:p-20 shadow-2xl relative overflow-hidden">
          ...
          <div className="max-w-2xl relative z-10">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <a href="mailto:gurushaa11@gmail.com" className="px-8 py-4 bg-[#f0b92f] text-gray-900 font-semibold rounded-full hover:bg-[#e9c766] transition-colors flex items-center gap-2 text-sm">
                Start a Project
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
              </a>
              <button className="px-8 py-4 bg-transparent border border-gray-600 text-white font-medium rounded-full hover:bg-gray-800 transition-colors text-sm">
                View Full Resume
              </button>
            </div>
          </div>
