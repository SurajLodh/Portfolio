    ...
    <div className="bg-background transition-colors duration-300 w-full min-h-screen text-foreground overflow-hidden">
      <div className="max-w-7xl mx-auto px-8 pt-12 lg:pt-20 pb-20 relative z-10">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 mb-20 lg:mb-32">
          ...
          <div className="flex-1 space-y-10 relative">
            ...
            <div className="space-y-4">
              <span className="text-foreground bg-white border-2 border-foreground px-4 py-1.5 rounded-full text-xs font-headline font-bold shadow-[2px_2px_0px_#1E293B] uppercase tracking-[0.2em] inline-block mb-4">Get in Touch</span>
            ...
            <div className="space-y-4 pt-2">
              <div className="inline-flex items-center gap-4 px-6 py-3 bg-white border-2 border-foreground rounded-full text-foreground shadow-[4px_4px_0px_#1E293B] font-headline font-bold text-sm">
            ...
            <div className="relative pt-12 max-w-sm hidden lg:block">
              ...
              <div className="border-4 border-foreground rounded-[2rem] overflow-hidden shadow-pop bg-white">
                <img 
              ...
              <div className="absolute -bottom-6 -right-12 bg-accent border-4 border-foreground px-6 py-4 rounded-2xl shadow-pop max-w-[240px] rotate-3">
                <p className="font-headline font-bold text-white text-lg leading-snug drop-shadow-[1px_1px_0px_#1E293B]">
          ...
          <div className="flex-1 lg:mt-0 mt-20 relative">
            <div className="absolute -inset-4 bg-tertiary border-4 border-foreground rounded-[3rem] rotate-2 -z-10 shadow-[12px_12px_0px_#1E293B]"></div>
            
            <div className="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-sm border-4 border-foreground relative z-10">
              ...
              <form className="space-y-8">
                <div className="flex flex-col md:flex-row gap-6">
                  <div className="flex-1 space-y-2">
                    ...
                    <input 
                      ...
                      className="w-full px-4 py-3 border-2 border-foreground rounded-lg focus:outline-none focus:ring-4 focus:ring-accent/30 focus:border-accent transition-all text-foreground bg-background placeholder:text-muted-foreground shadow-[2px_2px_0px_#1E293B]"
                    />
                  </div>
                  <div className="flex-1 space-y-2">
                      ...
                      <button
                        ...
                        className={`px-5 py-2.5 font-headline font-bold text-sm rounded-full transition-all border-2 ${
                          selectedInterest === interest
                            ? 'bg-quaternary border-foreground text-foreground shadow-[2px_2px_0px_#1E293B] translate-y-[2px]'
                            : 'bg-white border-foreground text-foreground shadow-[4px_4px_0px_#1E293B] hover:-translate-y-1 hover:shadow-[6px_6px_0px_#1E293B]'
                        }`}
                      >
                        {interest}
                      </button>
                ...
                <div className="space-y-2">
                  ...
                  <textarea 
                    ...
                    className="w-full px-4 py-4 border-2 border-foreground rounded-lg focus:outline-none focus:ring-4 focus:ring-accent/30 focus:border-accent transition-all resize-none text-foreground bg-background placeholder:text-muted-foreground shadow-[4px_4px_0px_#1E293B]"
                    rows={4}
                  ></textarea>
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 pt-20 relative">
          ...
          <div className="bg-white border-4 border-foreground rounded-2xl p-8 shadow-pop relative z-10 hover:-translate-y-2 transition-transform duration-300">
            <div className="w-14 h-14 rounded-full bg-tertiary border-2 border-foreground flex items-center justify-center shadow-[4px_4px_0px_#1E293B] mb-6">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className="text-foreground"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path><line x1="9" x2="15" y1="10" y2="10"></line><line x1="12" x2="12" y1="7" y2="13"></line></svg>
            </div>
          ...
          <div className="bg-white border-4 border-foreground rounded-2xl p-8 shadow-pop relative z-10 hover:-translate-y-2 transition-transform duration-300">
            <div className="w-14 h-14 rounded-full bg-secondary border-2 border-foreground flex items-center justify-center shadow-[4px_4px_0px_#1E293B] mb-6">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className="text-foreground"><circle cx="12" cy="5" r="2"></circle><path d="M4 22 10.5 8.5"></path><path d="M20 22 13.5 8.5"></path><path d="M6 16h12"></path></svg>
            </div>
          ...
          <div className="bg-white border-4 border-foreground rounded-2xl p-8 shadow-pop relative z-10 hover:-translate-y-2 transition-transform duration-300">
            <div className="w-14 h-14 rounded-full bg-quaternary border-2 border-foreground flex items-center justify-center shadow-[4px_4px_0px_#1E293B] mb-6">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className="text-foreground"><path d="m12 3-1.912 5.813a2 2 0 0 1-1.275 1.275L3 12l5.813 1.912a2 2 0 0 1 1.275 1.275L12 21l1.912-5.813a2 2 0 0 1 1.275-1.275L21 12l-5.813-1.912a2 2 0 0 1-1.275-1.275L12 3Z"></path><path d="M5 3v4"></path><path d="M19 17v4"></path><path d="M3 5h4"></path><path d="M17 19h4"></path></svg>
            </div>
