...
export default function Projects() {
  return (
    <main className="py-24 bg-[#f8f9fa]" id="projects">
      <div className="max-w-7xl mx-auto px-8">
        <div className="mb-20">
          <h2 className="text-4xl md:text-5xl font-headline font-bold text-gray-900 border-b-[5px] border-[#e9c766] inline-block pb-1">
              Projects
          </h2>
        </div>
